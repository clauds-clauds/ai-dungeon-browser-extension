...
class Configuration {
    ...
    */
    ...
    /**
     * CSS selector for the "Settings" button.
    */
    static ID_SETTINGS_BUTTON = 'button[role="button"][aria-label="Settings"]';

    /**
     * CSS selector for the "Daily Rewards" button.
    */
    static ID_REWARDS_BUTTON = 'div[role="button"][aria-label="Daily Rewards"]';

    /**
     * Element ID for the circular menu button.
    */
    static ID_EXTENSION_MENU_CIRCLE_BUTTON = 'de-menu-circle-button';
